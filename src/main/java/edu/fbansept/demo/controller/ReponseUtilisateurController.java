...
public class ReponseUtilisateurController {
    ...
    public ResponseEntity<ReponseUtilisateur> add(
            @RequestBody @Valid ReponseUtilisateur _reponseUtilisateur,
            @AuthenticationPrincipal AppUserDetails _userDetails) {

        _reponseUtilisateur.setId(null);
        _reponseUtilisateur.setUtilisateur(_userDetails.getUtilisateur());

        reponseUtilisateurDao.save(_reponseUtilisateur);
        return new ResponseEntity<>(_reponseUtilisateur, HttpStatus.CREATED);
    }
    ...
    public ResponseEntity<ReponseUtilisateur> update(
        ...
        return new ResponseEntity<>(_reponseUtilisateur, HttpStatus.OK);
    }
